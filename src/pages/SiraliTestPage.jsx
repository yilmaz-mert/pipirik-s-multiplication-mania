...
export default function SiraliTestPage() {
  ...
  return (
    <div className="w-full h-full relative flex flex-col items-center overflow-x-hidden overflow-y-auto pb-10 pt-12 px-4">
      ...
      {/* Soru Kutusu - Orijinal Figma: 287x69, Shadow Drop */}
      <div 
      ...
      {/* Seçim Kutusu - Orijinal Figma: 297x259, Shadow Drop */}
      <div 
      ...
      >
        {/* Yıldızlar - Orijinal 79x76 boyutunda ve flex-center ile ortalı */}
           ...
           {questionsList.map((item) => {
              return (
                <button
                  ...
                  // Orijinal değerler: width 79px, height 76px
                  className="relative w-19.75 h-19 flex items-center justify-center transition-transform active:scale-90 hover:scale-105"
                >
                  <svg 
                  ...
                  {/* Yazılar kalın (bold) ve boyutları büyütüldü */}
                  <span className="relative z-10 font-outfit font-bold text-[14px] text-tema-yazi mt-1">
                    {item.label}
                  </span>
                </button>
              );
